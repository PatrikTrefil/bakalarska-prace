...
Pokud máte k dispozici příkaz \href{https://curl.se/}{\lstinline{curl}}, tak uživatele \textit{s rolí správce dotazníků} můžete vytvořit pomocí skriptu \lstinline{./src/scripts/create_form_manager_user.sh}. % TODO: overfull hbox
