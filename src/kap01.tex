...
\begin{itemize}
  ...
  \item
  Jako plnitel chci vidět vyhodnocení svých dotazníků, u kterých to správce povolil, abych mohl sledovat svůj pokrok a výsledky.
  \item
  Jako správce dotazníků chci moci dovolit plniteli vidět výsledky konkrétního dotazníku - číselná hodnota/graf/text, abych mohl sdílet výsledky a zpětnou vazbu s uživateli.
  \item
