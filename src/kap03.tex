...
Důvody k tomuto rozhodnutí jsou blíže popsány v sekci XXX. % TODO: doplnit ref
...
Pokud se uživatel pokusí změnit své ID, tak se změna neprovede.
...
% TODO: make this section more understandable
...
To bychom mohli vyřešit zavedením následujícího omezení: \uv{Každý uživatel má zadaný vždy maximálně jeden úkol na vyplnění jednoho dotazníku}.
